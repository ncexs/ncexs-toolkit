...
### 🧹 저장소 및 정리
* **Compact OS 압축:** 시스템 바이너리를 안전하게 압축하여 **2GB – 5GB**의 저장 공간을 확보합니다.
...
* **이벤트 로그 클리너:** Windows 이벤트 로그를 비우고 여유 공간(MB)을 정확하게 보고합니다.
* **스마트 앱 제거기:** 빠른 퍼지 검색으로 제거 스크립트를 즉시 실행합니다.
* **휴지통 및 디스크 정리:** 삭제된 파일을 안전하게 정리하거나 기본 디스크 정리 도구를 실행합니다.
